...
#$(combo_2nd_arch_prefix)TARGET_NDK_GCC_VERSION := uber-5.3
$(combo_2nd_arch_prefix)TARGET_NDK_GCC_VERSION := uber-4.9

ifeq ($(strip $(TARGET_GCC_VERSION_EXP)),)
$(combo_2nd_arch_prefix)TARGET_GCC_VERSION := uber-4.9
$(combo_2nd_arch_prefix)TARGET_LEGACY_GCC_VERSION := uber-4.9
#$(combo_2nd_arch_prefix)TARGET_GCC_VERSION := uber-5.3
#$(combo_2nd_arch_prefix)TARGET_LEGACY_GCC_VERSION := uber-5.3
...
##ifneq ($(filter 4.6 4.6.% 4.7 4.7.% 4.8 4.9 uber-4.8 uber-4.9 uber 5.3 uber-4.8.% uber-4.9.% uber-5.3.%, $($(combo_2nd_arch_prefix)TARGET_GCC_VERSION)),)
